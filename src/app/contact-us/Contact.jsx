        ...
        <section className="bg-[#fafafa] mt-20">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 px-6">
                ...
                <div className="relative rounded-3xl overflow-hidden h-[380px] sm:h-[450px]">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center px-4 sm:px-8 text-white">
                        <h2 className="text-2xl sm:text-3xl font-semibold mb-6" style={{ fontFamily: "Roboto Slab, serif" }}>
                            Reach Out to Us
                        </h2>
