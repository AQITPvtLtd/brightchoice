        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
                ...
                <input
                    ...
                    className="w-full rounded-full text-white border border-gray-300 px-5 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-gray-700"
                    required
                />
            </div>
            ...
            <div>
                ...
                <textarea
                    ...
                    onChange={handleChange}
                    className="w-full rounded-2xl text-white border border-gray-300 px-5 py-3 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-gray-700"
                ></textarea>
            </div>
